...
WebUI.navigateToUrl(GlobalVariable.URL + 'CarReport/carsByYear?from=2021&to=2022&status=2')
...
CustomKeywords.'com.reports.accountreports.CommonUtils.VerifyFileDownloaded'('جميع السيارات حسب السنة.xlsx')

CustomKeywords.'com.reports.accountreports.CommonUtils.VerifyFileDownloaded'('جميع السيارات حسب السنة.pdf')

WebUI.selectOptionByValue(findTestObject('Manager Reports/Car Reports/PendingCarsReport/ShowDropdown'), '50', false)

CustomKeywords.'com.managerreports.carreports.CarsByYears.verifyShowEntry'(50)

CustomKeywords.'com.managerreports.carreports.PendingCars.verifyPagination'()

CustomKeywords.'com.managerreports.carreports.CarsByYears.verifyTextinRows'()
