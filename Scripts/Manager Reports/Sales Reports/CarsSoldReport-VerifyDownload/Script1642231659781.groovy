...
WebUI.sendKeys(findTestObject('Manager Reports/Sales Reports/Car Sold Report/FromDate'), '01012022')

WebUI.sendKeys(findTestObject('Manager Reports/Sales Reports/Car Sold Report/ToDate'), '01312022')
...
CustomKeywords.'com.reports.accountreports.CommonUtils.VerifyFileDownloaded'('All Sold Vehicles.xlsx')

CustomKeywords.'com.reports.accountreports.CommonUtils.VerifyFileDownloaded'('All Sold Vehicles.pdf')
