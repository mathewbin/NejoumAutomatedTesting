...
CustomKeywords.'com.managerreports.autoreports.CarMissingPrices.verifyTextFileData'(findTestObject('Manager Reports/Auto Reports/Car Missing Price/StatusDropdown'), 
    'Cars with missing prices.xlsx')
