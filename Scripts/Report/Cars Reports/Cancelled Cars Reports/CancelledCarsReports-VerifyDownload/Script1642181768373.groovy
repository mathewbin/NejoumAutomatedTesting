...
WebUI.click(findTestObject('Report/CarsReports/Cancelled Cars Reports/ExcelButton'))

WebUI.click(findTestObject('Report/CarsReports/Cancelled Cars Reports/PDFButton'))

WebUI.click(findTestObject('Report/CarsReports/Cancelled Cars Reports/CopyButton'))

CustomKeywords.'com.reports.carsreports.CancelledCarsReports.VerifyCopyButton'()

WebUI.click(findTestObject('Report/CarsReports/Cancelled Cars Reports/PrintButton'))

WebUI.closeWindowIndex(1)

WebUI.switchToWindowIndex(0)

CustomKeywords.'com.reports.accountreports.CommonUtils.VerifyFileDownloaded'('CarBike Cancelled Details.xlsx')

CustomKeywords.'com.reports.accountreports.CommonUtils.VerifyFileDownloaded'('CarBike Cancelled Details.pdf')
