...
WebUI.click(findTestObject('Report/CarsReports/PDFButton'))

WebUI.click(findTestObject('Report/CarsReports/CopyButton'))

CustomKeywords.'com.reports.carsreports.CarsReports.VerifyCopyButton'()

WebUI.click(findTestObject('Report/CarsReports/PrintButton'))
