...
WebUI.selectOptionByValue(findTestObject('Report/CarsReports/ShowDropdown'), '100', false)

CustomKeywords.'com.reports.carsreports.CarsReports.verifyShowEntry'(findTestObject('Report/CarsReports/ShowDropdown'), 
    100)

CustomKeywords.'com.reports.carsreports.CarsReports.verifyPagination'(findTestObject('Report/CarsReports/ShowDropdown'), 
    findTestObject('Object Repository/Report/CarsReports/PreviousButton'), findTestObject('Object Repository/Report/CarsReports/NextButton'))
