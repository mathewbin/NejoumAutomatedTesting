...
WebUI.selectOptionByValue(findTestObject('Report/CarsReports/All Cars Reports/ShowDropdown'), '100', false)

CustomKeywords.'com.reports.carsreports.CarsReports.verifyShowEntry'(findTestObject('Report/CarsReports/All Cars Reports/ShowDropdown'), 
    100)

CustomKeywords.'com.reports.carsreports.CarsReports.verifyPagination'(findTestObject('Report/CarsReports/All Cars Reports/ShowDropdown'), 
    findTestObject('Report/CarsReports/All Cars Reports/PreviousButton'), findTestObject('Report/CarsReports/All Cars Reports/NextButton'))

CustomKeywords.'com.reports.carsreports.CarsReports.verifyTextinRows'()
