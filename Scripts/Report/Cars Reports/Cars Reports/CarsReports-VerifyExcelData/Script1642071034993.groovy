...
WebUI.selectOptionByValue(findTestObject('Report/CarsReports/All Cars Reports/DateDropdown'), '1', false)

WebUI.selectOptionByValue(findTestObject('Report/CarsReports/All Cars Reports/CountryDropdown'), '-1', false)

CustomKeywords.'com.reports.carsreports.CarsReports.selectStatus'(Status)

WebUI.selectOptionByValue(findTestObject('Report/CarsReports/All Cars Reports/Auction'), '7', false)

WebUI.sendKeys(findTestObject('Report/CarsReports/All Cars Reports/FromDate'), FromDate)

WebUI.sendKeys(findTestObject('Report/CarsReports/All Cars Reports/ToDate'), ToDate)

WebUI.click(findTestObject('Report/CarsReports/All Cars Reports/FilterButton'))
...
WebUI.selectOptionByValue(findTestObject('Report/CarsReports/All Cars Reports/DateDropdown'), '2', false)
...
WebUI.selectOptionByValue(findTestObject('Report/CarsReports/All Cars Reports/ShowDropdown'), '-1', false)
